...
def extract_youtube ():
    ...
    try:
        ...
        for company in searches.get("company", []):
            ...
            write_to_file (path_to_file, "extract_youtube", videos)
        ...
        for company in searches.get("company", []):
            ...
            if len(videos) > 0:
                for video in videos:
                    video["company"] = name
                    video["search_query"] = search_query
            write_to_file (path_to_file, "extract_youtube_oauth", videos)
...
def extract_reddit ():
    ...
    try:
        ...
        write_to_file (path_to_file, "extract_reddit_subreddits", posts_and_comments)
        ...
        for company in searches.get("company", []):
            ...
            write_to_file (path_to_file, "extract_reddit_searched", posts_and_comments)
...
def extract_reddit_oauth ():
    ...
    try:
        ...
        if posts_and_comments is None:
            posts_and_comments = {"posts": [], "comments": []}
        write_to_file (path_to_file, "extract_reddit_oauth_subreddits", posts_and_comments)
        ...
        for company in searches.get("company", []):
            ...
            posts_and_comments["company"] = name
            posts_and_comments["search_query"] = search_query
            write_to_file (path_to_file, "extract_reddit_oauth_searched", posts_and_comments)
...
def extract_news_marketaux_stocks ():
    ...
    try:
        ...
        for company in searches.get("company", []):
            ...
            write_to_file(path_to_file, "extract_news_marketaux_stocks", articles)
...
def extract_news_marketaux_search ():
    ...
    try:
        ...
        for company in searches.get("company", []):
            ...
            write_to_file(path_to_file, "extract_news_marketaux_search", articles)
...
def extract_news_dataio ():
    ...
    try:
        ...
        for company in searches.get("company", []):
            ...
            write_to_file(path_to_file, "extract_news_dataio", articles)
...
def extract_news_apiorg ():
    ...
    try:
        ...
        for company in searches.get("company", []):
            ...
            write_to_file(path_to_file, "extract_news_apiorg", articles)
...
def extract_googlesearch ():
    ...
    try:
        ...
        for company in searches.get("company", []):
            ...
            write_to_file (path_to_file, "extract_googlesearch", articles)
